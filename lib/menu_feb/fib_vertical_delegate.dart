import 'package:flutter/material.dart';
 ...
 class FibVerticalDelegate extends FlowDelegate{
  final AnimationController animation;

   FibVerticalDelegate({required this.animation}) :super(repaint: animation);
  ...
  @override
  bool shouldRepaint(covariant FlowDelegate oldDegaate) => false;
